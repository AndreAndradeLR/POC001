<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" Inherits="MonFisicoInd" Codebehind="MonFisicoInd.aspx.cs" %>
  ...
  <FooterStyle BackColor="#f4f5f5" Font-Bold="true" HorizontalAlign="Right" />
     <Columns>
        ...
        <asp:BoundField DataField="vl_real" HtmlEncode="false" DataFormatString="{0:N2}"  
                    HeaderText="Realizado (%)" ItemStyle-HorizontalAlign="Right" />  
        <asp:TemplateField  HeaderText="Realizado / Planejado (%)" ItemStyle-HorizontalAlign="Right">
        <ItemTemplate>
