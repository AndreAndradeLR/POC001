<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" Inherits="frmEntidade"  Codebehind="frmEntidade.aspx.cs" %>
...
<div class="bucket_container"><div class="bucket_top"><span></span></div><div class="bucket_content"><div class="clear"></div> 
    ...
    <div class="formElement">
        ...
        <td>  <asp:TextBox ID="txtnm_entidade" Width="250px" MaxLength="500" runat="server"></asp:TextBox>
        ...
        <asp:GridView ID="GridView1" DataKeyNames="t01_cd_entidade" Width="100%" GridLines="Both"
            ...
            <asp:BoundField DataField="nm_entidade" HtmlEncode="false" 
                HeaderText="Entidade" SortExpression="nm_entidade" />
            </Columns>
            </asp:GridView>
        </asp:Panel>
