<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" Inherits="Rel_MetaFisica" Codebehind="Rel_MetaFisica.aspx.cs" %>
...
<h2 id="H7">Relatório de Metas Físicas</h2></div>
...
<%--<div><asp:Button ID="btnPrint" CssClass="button" OnClick="cmdImprimir_Click" Visible="false" runat="server" Text="Imprimir" /></div>--%>
<div style="text-align:right"><asp:Button ID="btnPrint" CssClass="button" OnClick="cmdImprimir_Click" Visible="false" runat="server" Text="Imprimir" /><asp:Button ID="btnExportar" Visible="false" runat="server" Text="Exportar para Excel" OnClick="cmdExportar_Click" /></div>
</div>
...
<div class="clear"></div></div><div class="bucket_bottom"><span></span></div><br />
</div>
</asp:Content>